...
square[27] = new Square("Malmö", "$260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("Göteborg", "$150", "#FFFFFF", 150, 2);
...
chanceCards[11] = new Card("ADVANCE to Illinois Avenue. If you pass \"Start\" collect $200.", function() { advance(24);});
...
chanceCards[14] = new Card("ADVANCE to St. Charles Place. If you pass \"Start\" collect $200.", function() { advance(11);});
