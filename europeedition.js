...
square[5] = new Square("Railroad", "$200", "#FFFFFF", 200, 1);
...
square[15] = new Square("Railroad", "$200", "#FFFFFF", 200, 1);
...
square[24] = new Square("Amsterdam", "$240", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
square[25] = new Square("Railroad", "$200", "#FFFFFF", 200, 1);
square[26] = new Square("Malmö", "$260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[27] = new Square("Göteborg", "$260", "#FFFF00", 260, 8, 22, 110, 330, 800, 975, 1150);
square[28] = new Square("Stockholm", "$150", "#FFFFFF", 150, 2);
square[29] = new Square("Frankfurt", "$280", "#FFFF00", 280, 8, 24, 120, 360, 850, 1025, 1200);
square[30] = new Square("Go to Jail", "Go directly to Jail. Do not pass GO. Do not collect $200.", "#FFFFFF");
square[31] = new Square("Cologne", "$300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[32] = new Square("Bonn", "$300", "#008000", 300, 9, 26, 130, 390, 900, 1100, 1275);
square[33] = new Square("Community Chest", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[34] = new Square("Innsbruck", "$320", "#008000", 320, 9, 28, 150, 450, 1000, 1200, 1400);
square[35] = new Square("Short Line", "$200", "#FFFFFF", 200, 1);
square[36] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[37] = new Square("Vienna", "$350", "#0000FF", 350, 10, 35, 175, 500, 1100, 1300, 1500);
square[38] = new Square("Luxury Tax", "Pay $100", "#FFFFFF");
square[39] = new Square("Graz", "$400", "#0000FF", 400, 10, 50, 200, 600, 1400, 1700, 2000);
