...
square[6] = new Square("Avenue Louise/Louizalaan (Belgium)", "$100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[7] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[8] = new Square("Rue des Bouchers/Beenhouwers-straat (Belgium)", "$100", "#87CEEB", 100, 4, 6, 30, 90, 270, 400, 550);
square[9] = new Square("Grand-Place/Grote Markt (Belgium)", "$120", "#87CEEB", 120, 4, 8, 40, 100, 300, 450, 600);
...
square[21] = new Square("Oxford Street (Great Britain)", "$220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[22] = new Square("Chance", "FOLLOW INSTRUCTIONS ON TOP CARD", "#FFFFFF");
square[23] = new Square("Piccadilly (Great Britain)", "$220", "#FF0000", 220, 7, 18, 90, 250, 700, 875, 1050);
square[24] = new Square("Park Lane (Great Britain)", "$240", "#FF0000", 240, 7, 20, 100, 300, 750, 925, 1100);
...
chanceCards[11] = new Card("Advance to Park Lane (Great Britain). If you pass \"Start\" collect $200.", function() { advance(24);});
